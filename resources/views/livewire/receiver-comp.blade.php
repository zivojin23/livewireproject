...
<div class="flex">
    ...
    <div class="w-3/5 mx-auto">
        <form wire:submit="storeReceiver" autocomplete="on">
        @csrf
        ...
        <div class="w-3/5 mx-auto">
            ...
            {{-- <div class="flex flex-col w-4/5 mx-auto my-8">
                ...
                <input class="shadow p-2.5 text-sm rounded-lg bg-gray-50 border border-gray-300" 
                        wire:model="material_id" id="material_id" type="text" placeholder="E.g. 20 kg, 500 l, 160 m2..." autocomplete>  
                @error('material_id')<span class="text-red-600">{{ $message }}</span>@enderror
            </div> --}}
...
<div class="w-4/5 mx-auto mt-10">
    ...
    <div class="flex justify-between mb-4">
        <div class="w-3/5">
            <input class="w-full block p-2.5 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500"
                    wire:model.debounce.300ms="search" id="search" placeholder="Search by quantity">
        </div>       
    ...
    <tbody>
        ...
        <tr class="bg-white border-b hover:bg-gray-50">
            ...
            <td class="py-3 px-5">{{ $receiver->material->material_name }}</td>
            <td class="py-4 px-6">{{ $receiver->quantity }}</td>
            <td class="py-4 px-6">{{ $receiver->supplier->supplier_name }}</td>
